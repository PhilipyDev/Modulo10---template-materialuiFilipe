        ...
        <CardContent>
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow style={{ backgroundColor: '#ffd54f' }}>
                  <TableCell style={{ color: '#424242' }}>#</TableCell>
                  <TableCell style={{ color: '#424242' }}>Título</TableCell>
                  <TableCell align="right" style={{ color: '#424242' }}>Descrição</TableCell>
                  <TableCell align="right" style={{ color: '#424242' }}>Data de Início</TableCell>
                  <TableCell align="right" style={{ color: '#424242' }}>Data de Finalização</TableCell>
                  <TableCell align="right" style={{ color: '#424242' }}>Status</TableCell>
                  <TableCell align="right" style={{ color: '#424242' }}>Recurso</TableCell>
